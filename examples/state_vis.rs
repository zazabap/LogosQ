...
fn main() -> std::io::Result<()> {
    ...
    if args.len() > 1 && !show_basic && !show_superposition && !show_phase && !show_arbitrary && !show_evolution {
    ...
    if show_arbitrary {
        ...
        arbitrary_state1.vector[1] = Complex64::new(
            theta.sin() * phi.cos(), 
            theta.sin() * phi.sin()
        );
        ...
        arbitrary_state2.vector[1] = Complex64::new(
            theta.sin() * phi.cos(), 
            theta.sin() * phi.sin()
        );
